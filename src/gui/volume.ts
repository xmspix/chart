...
export default function volume(view:any, quotes:any) {
...
function volumeLines(ctx:any, quotes:any, i:any, boxContent:any, stickLength:any, stickMargin:any, style:any) {
...
function volumeBars(ctx:any, quotes:any, i:any, boxContent:any, stickLength:any, stickMargin:any, style:any) {
...
function drawVolumeBar(ctx:any, o:any, c:any, xStart:any, xEnd:any, fillColor:any, borderColor:any) {
  let width = xEnd - xStart;
  if (width % 2) {
    width += 1;
  }

  const boxStick = [xStart, o, (xEnd - xStart), (c - o)];
